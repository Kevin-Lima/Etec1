...
public class MenuComissao extends JFrame {
    ...
    private JPanel criarHeader() {
        ...
        gbc.insets = new Insets(0, 0, 0, 0); // Ajuste fino: (top, left, bottom, right)
    ...
    private JPanel criarPainelMenu() {
        ...
        panel.setLayout(new GridLayout(4, 1, 10, 10));// GridLayout(linhas, colunas, espaçamento Horizontal, espaçamento Vertical)
