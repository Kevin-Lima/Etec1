...
public class Calculadora extends JFrame {
    ...
    JButton somar, subtrair, multiplicar, dividir, restoDivisao, dobro, quadrado, cubo,  raizQuadrada,  porcentagem, sair, limpar, ocultar, exibirR;
...
// Essa função define a posiçao e o tamanho de cada componente na tela: componente.setBounds(posiçãoX, posiçãoY, largura, altura);
        ...
        sair.setBounds(400,250,130,25);
        limpar.setBounds(540,250,130,25);
        ocultar.setBounds(260,250,130,25);
        exibirR.setBounds(120,250,130,25);
...
// Quando o usuário clicar em um botão, a conta vai ser feita e tudo que tiver dentro desse método também vai ser executado.
        ActionListener newLayout = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                sair.setBounds(330,230,130,25);
                limpar.setBounds(470,230,130,25);
                ocultar.setBounds(190,230,130,25);
                exibirR.setBounds(50,230,130,25);
        ...
        ocultar.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                //faz o rotulo (JLabel) sumir
                rotulo1.setVisible(!rotulo1.isVisible());//isVisible() deixa o rotulo invisivel
                rotulo2.setVisible(!rotulo2.isVisible());
            }
        });

        exibirR.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                //deixa o rotulo (JLabel) visivel
