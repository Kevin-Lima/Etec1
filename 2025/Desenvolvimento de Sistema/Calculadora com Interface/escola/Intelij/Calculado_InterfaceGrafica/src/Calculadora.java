...
// Essa função define a posiçao e o tamanho de cada componente na tela: componente.setBounds(posiçãoX, posiçãoY, largura, altura);
        ...
        somar.setBounds(50, 110, 140, 25);
        subtrair.setBounds(200, 110, 140, 25);
        multiplicar.setBounds(350, 110, 140, 25);
        dividir.setBounds(500, 110, 140, 25);
        porcentagem.setBounds(650, 110, 140, 25);

        restoDivisao.setBounds(50, 150, 140, 25);
        dobro.setBounds(200, 150, 140, 25);
        quadrado.setBounds(350, 150, 140, 25);
        cubo.setBounds(500, 150, 140, 25);
        raizQuadrada.setBounds(650, 150, 140, 25);
