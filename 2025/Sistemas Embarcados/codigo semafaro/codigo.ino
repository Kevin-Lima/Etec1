void setup()
{
  ...
  pinMode(6, OUTPUT);  // Verde 1
  pinMode(5, OUTPUT);  // Amarelo 1
  pinMode(7, OUTPUT);  // Vermelho 1
  
  pinMode(2, OUTPUT);  // Verde 2
  pinMode(3, OUTPUT);  // Amarelo 2
  pinMode(4, OUTPUT);  // Vermelho 2
  
  pinMode(10, OUTPUT); // Verde 3
  pinMode(9, OUTPUT);  // Amarelo 3
  pinMode(8, OUTPUT);  // Vermelho 3
  
  pinMode(13, OUTPUT); // Verde 4
  pinMode(12, OUTPUT); // Amarelo 4
  pinMode(11, OUTPUT); // Vermelho 4
}
